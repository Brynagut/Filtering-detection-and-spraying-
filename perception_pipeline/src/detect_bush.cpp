...
void depthPointsCallback(const sensor_msgs::PointCloud2ConstPtr& cloud_msg) {
    ...
    // Set the axis for which to search for planes, in this case, the floor
    ...
    //EuclideanClusterExtraction functions best the octree data structure fetches data from octomap 
...
int main(int argc, char** argv) {
    ...
    depth_sub = n.subscribe("/camera1/depth/points", 1, depthPointsCallback);
    ...
    ec.setMinClusterSize (10); // min number of points cluser needs to be valid
    ec.setMaxClusterSize (2500); // max number of points cluser needs to be valid
